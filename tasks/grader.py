...
NOTE: This module is intentionally self-contained with zero external
imports beyond the stdlib so that the remote OpenEnv validator can
load it via importlib without any dependency resolution issues.
"""
from typing import Dict, Any


# Inline copy of configs.env_config.GRADE_WEIGHTS
# (kept here to avoid import failures on the remote validator)
